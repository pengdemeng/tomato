...
//未完成事务列表页面
public class ActivityListPage_done extends Composite {
	Table table;

	public ActivityListPage_done(Composite parent, int style) throws ClassNotFoundException, SQLException {
		super(parent, style);
	...
	public void SetListValues() throws ClassNotFoundException, SQLException {
		...
		List<Activity> activities = dbmgr.GetDoneActivities();
